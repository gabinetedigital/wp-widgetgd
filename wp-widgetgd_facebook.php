...
class FacebookGD extends WP_Widget
{
  ...
  {
    $instance = wp_parse_args( (array) $instance, array( 'titulo' => '', 'fanpage' => '', 'largura' => '', 'altura' => '', 'cor' => 'light', 'faces' => 0, 'header' => 0, 'border' => 0, 'posts' => 0, 'colunas' => '3', 'css_class'=>'' ) );
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('cor'); ?>">Cor do LikeBox: <input class="widefat" id="<?php echo $this->get_field_id('cor'); ?>" name="<?php echo $this->get_field_name('cor'); ?>" type="text" value="<?php echo attribute_escape($cor); ?>"/></label>light ou dark</p>
